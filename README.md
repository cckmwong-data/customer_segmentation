# Customer Segmentation & Sales Automated Pipeline
...
## Skills Demonstrated
✔ Data Engineering (Extract-Transform-Load (ETL) orchestration, scheduling)
...
<img src="./images/radar.png" width="" height="400">
...
- **Potential growth for Young customers** Younger customers aged 18–30 (*Young Urban Starters*) contribute lower total premium due to lower coverage but may see future growth through retention initiatives.
...
- K-Prototypes clustering for a mix of numeric and categorical data
- Segment labeling and description generated by Gemini 2.5 Flash
  
**Load**:
- Loading the updated customers, sales and products tables to Google BigQuery, a cloud data warehousing, where processed model outputs were stored as tables for reporting and analysis, alongside views generated from SQL queries.
- Automation of the above process via GitHub Actions (daily at 10PM UK time)

![Alt text](./images/bq.jpg)

**Business Intelligence**: A [live dashboard](https://app.powerbi.com/view?r=eyJrIjoiOTdiZmExN2YtMGY0Yy00Mjc0LWI5MTgtOWJiYzM2ZDA4ZDFmIiwidCI6IjZjMWQ0MTUyLTM5ZDAtNDRjYS04OGQ5LWI4ZDZkZGNhMDcwOCIsImMiOjEwfQ%3D%3D) in Microsoft Power BI shows an analysis of customer and sales data for the company. Data is scheduled for an automatic update on a daily basis at 11PM UK time.
